  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      <View style={styles.headerBlock}>
        ...
        >
          <TouchableOpacity
            style={[styles.filterChip, { backgroundColor: "#000" }]}
          >
        ...
        {isLoading ? (
          ...
          <View style={styles.emptyStateCard}>
            ...
            <Text style={styles.emptySubtitle}>
              We couldn't find any clinics matching your search. Try a different
              name or location!
            </Text>
          </View>
        ) : (
            ...
            {clinics.map((clinic, index) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  {
                    backgroundColor:
                      CLINIC_COLORS[index % CLINIC_COLORS.length],
                  },
                ]}
              >
                ...
                <View style={styles.clinicActions}>
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      router.push(
                        `/appointment/book?clinicId=${clinic.id}` as any,
                      )
                    }
                  >
